...
def main():
    ...
    # Assuming columns are: timestamp,epoch,batch,step_loss,ema_loss,early_halting_rate,gini,avg_hops,avg_energy,attention_entropy,active_subnodes,credit_volatility,temporal_affinity
    ...
    metrics = [
        ...
        'avg_energy', 'attention_entropy', 'active_subnodes', 'credit_volatility', 
        'temporal_affinity'
    ]
